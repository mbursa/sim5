...
// physical constants in CGS unit system
...
#define Mdot_Edd        2.225475942e+18          //!< Eddington mass accretion rate [g/s * (M/Msun)]
                                                 //   64*pi*(mass of sun)*G/(speed of light)/(kappa_es); kappa_es=(0.20*(1+X)cm^2/g; X=hydrogen mass fraction (X=1.0)
#define L_Edd           1.257142540e+38          //!< Eddington luminosity [erg/s * (M/Msun)]
                                                 //   4*pi*(mass of sun)*G*(mass of proton)*(speed of light)/(Thomson sigma)
...
// physical constants in geometrical units (G=c=1)
...
#define joule2erg           1.000000e+07         //!< Joule->erg
